...
@section('content')
  ...
  <thead>
    <tr>
	  <th width=5%>Total No. Of Incident</th>
	  <td width=20%>{!!$incident !!}</td></tr>
      <tr><th>Total No. Of Fire Incident</th>
	  <td>{!!$noOfFire !!} </td></tr>
	  <th>Total No. Of Flood</th><td>{!!$noOfFlood !!}</td>
	   </tr><tr><th>Total No. Of Crisis</th><td>{!!$noOfCrisis!!}</td></tr>
